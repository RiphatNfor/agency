...
GRANT ALL PRIVILEGES ON auth.* TO 'agen_admin'@'localhost';
...
CREATE TABLE `users` (
    ...
    `Number_of_Travelers` VARCHAR(255),
    `phone` VARCHAR(15),
);
...
-- Inserting users
INSERT INTO `users` (`destination`, `travel_date`, `number_of_travelers`, `phone`, `email`, `ris_admin`, `department_id`ole`, `address`, `pob`, `dob`, `password`, `) VALUES
('Douala', '12/09/24', '3', 'john.doe@example.com', 'Manager', '123 Main St', 'New York', '1990-01-01', 'password123', FALSE, 1),
